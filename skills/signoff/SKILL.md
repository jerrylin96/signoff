...
> [!NOTE]
> **Scratchpad Lifecycle Sync (Step 8)**: Ensure `<appDataDir>/brain/<conversation-id>/scratch/scratchpad.md` is updated pre-signoff with final completion status, matching Step 8 in [make-feature](../make-feature/SKILL.md).
